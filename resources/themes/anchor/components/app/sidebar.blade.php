        ...
        <div class="flex flex-col justify-between w-full overflow-auto md:h-full h-svh pt-4 pb-2.5">
            <div class="relative flex flex-col">
                ...
                <div class="flex flex-col justify-start items-center px-4 space-y-1.5 w-full h-full text-slate-600 dark:text-zinc-400">
                    ...
                    <x-app.sidebar-dropdown text="Groups" icon="phosphor-stack" id="groups_dropdown" :active="(Request::is('projects'))" :open="(Request::is('project_a') || Request::is('project_b') || Request::is('project_c')) ? '1' : '0'">
                    ...
                    <x-app.sidebar-link href="/contacts" icon="phosphor-users" :active="Request::is('contacts')">Contacts</x-app.sidebar-link>
                </div>
            </div>
